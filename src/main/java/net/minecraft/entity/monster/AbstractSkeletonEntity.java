...
public abstract class AbstractSkeletonEntity extends MonsterEntity implements IRangedAttackMob {
   private final RangedBowAttackGoal<AbstractSkeletonEntity> aiArrowAttack = new RangedBowAttackGoal<>(this, 1.0D, 20, 20.0F);
   private final MeleeAttackGoal aiAttackOnCollide = new MeleeAttackGoal(this, 2.2D, false) {
      /**
