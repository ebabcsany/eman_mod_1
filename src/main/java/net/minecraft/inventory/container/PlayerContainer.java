...
public class PlayerContainer extends RecipeBookContainer<CraftingInventory> {
   ...
   public static final ResourceLocation EMPTY_ARMOR_SLOT_HELMET = new ResourceLocation(Eman_mod_1.MOD_ID,"item/empty_armor_slot_helmet");
   public static final ResourceLocation EMPTY_ARMOR_SLOT_CHESTPLATE = new ResourceLocation(Eman_mod_1.MOD_ID,"item/empty_armor_slot_chestplate");
   public static final ResourceLocation EMPTY_ARMOR_SLOT_LEGGINGS = new ResourceLocation(Eman_mod_1.MOD_ID,"item/empty_armor_slot_leggings");
   public static final ResourceLocation EMPTY_ARMOR_SLOT_BOOTS = new ResourceLocation(Eman_mod_1.MOD_ID,"item/empty_armor_slot_boots");
   public static final ResourceLocation EMPTY_ARMOR_SLOT_SHIELD = new ResourceLocation(Eman_mod_1.MOD_ID,"item/empty_armor_slot_shield");
