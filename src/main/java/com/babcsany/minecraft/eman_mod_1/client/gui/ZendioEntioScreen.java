package com.babcsany.minecraft.eman_mod_1.client.gui;
...
/*@OnlyIn(Dist.CLIENT)
/*public class ZendioEntioScreen extends ContainerScreen<ZendioEntioContainer> implements IRecipeShownListener {
    private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation(Eman_mod_1.MOD_ID,"textures/gui/container/zendio_entio_container.png");
    private static final ResourceLocation RECIPE_BUTTON_TEXTURE = new ResourceLocation(Eman_mod_1.MOD_ID,"textures/gui/container/jougzjhih_ldos.png");
    private final RecipeBookGui recipeBookGui = new RecipeBookGui();
    private boolean widthTooNarrow;

    public ZendioEntioScreen(ZendioEntioContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    protected void init() {
        ...
        this.ySize = 207;
        super.init();
        this.widthTooNarrow = this.width < 448;
