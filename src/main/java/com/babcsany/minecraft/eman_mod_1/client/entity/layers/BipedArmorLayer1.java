...
import com.babcsany.minecraft.eman_mod_1.client.entity.model.AbstractEpicTraderBipedModel;
import com.babcsany.minecraft.eman_mod_1.client.entity.model.AbstractEpicTraderModel;
...
@OnlyIn(Dist.CLIENT)
public class BipedArmorLayer1<T extends LivingEntity, M extends AbstractEpicTraderBipedModel<T>, A extends AbstractEpicTraderBipedModel<T>> extends LayerRenderer<T, M> {
   private static final Map<String, ResourceLocation> ARMOR_TEXTURE_RES_MAP = Maps.newHashMap();
   private final A modelLeggings;
   private final A modelArmor;

   public BipedArmorLayer1(IEntityRenderer<T, M> p_i50936_1_, A p_i50936_2_, A p_i50936_3_) {
      super(p_i50936_1_);
   ...
   protected A getArmorModelHook(T entity, ItemStack itemStack, EquipmentSlotType slot, A model) {
      return BipedArmorLayer1.getArmorModel(entity, itemStack, slot, model);
   }

   public static <A extends AbstractEpicTraderBipedModel<?>> A getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType slot, A _default)
   {
      A model = BipedArmorLayer1.getArmorModel(entityLiving, itemStack, slot, _default);
      return model == null ? _default : model;
   }

   @OnlyIn(Dist.CLIENT)
   @Nullable
   <A extends AbstractEpicTraderBipedModel<?>> A getArmorModel1(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlotType armorSlot, A _default)
   {
      return null;
   }
