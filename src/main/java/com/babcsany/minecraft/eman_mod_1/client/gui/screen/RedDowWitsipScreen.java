package com.babcsany.minecraft.eman_mod_1.client.gui.screen;
...
@OnlyIn(Dist.CLIENT)
public class RedDowWitsipScreen extends ContainerScreen<RedDowWitsipContainer> implements IRecipeShownListener {
   private static final ResourceLocation CRAFTING_TABLE_GUI_TEXTURES = new ResourceLocation(Eman_mod_1.MOD_ID,"textures/gui/container/red_dow_witsip_container.png");
   private static final ResourceLocation RECIPE_BUTTON_TEXTURE = new ResourceLocation(Eman_mod_1.MOD_ID,"textures/gui/container/crafting_button.png");
   private final RecipeBookGui recipeBookGui = new RecipeBookGui();
   private boolean widthTooNarrow;

   public RedDowWitsipScreen(RedDowWitsipContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
