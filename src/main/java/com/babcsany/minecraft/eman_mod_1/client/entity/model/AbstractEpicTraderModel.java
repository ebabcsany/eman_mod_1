...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractEpicTraderModel<T extends CreatureEntity> extends AbstractEpicTraderBipedModel<T> {
   protected AbstractEpicTraderModel(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
