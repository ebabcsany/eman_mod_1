...
/*public class AbstractZerunerdifirteRender<T extends Zerunerdifirte, M extends ZerunerdifirteModel<T>> extends BipedRenderer<T, M> {

    private static final ResourceLocation TEXTURE = new ResourceLocation(Eman_mod_1.MOD_ID,
            "textures/entity/zerunerdifirte.png");

    protected AbstractZerunerdifirteRender(EntityRendererManager p_i50974_1_, M p_i50974_2_, M p_i50974_3_, M p_i50974_4_) {
