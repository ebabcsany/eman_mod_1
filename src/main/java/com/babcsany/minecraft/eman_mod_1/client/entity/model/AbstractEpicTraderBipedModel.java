...
@OnlyIn(Dist.CLIENT)
public class AbstractEpicTraderBipedModel<T extends LivingEntity> extends AgeableModel<T> implements IHasArm, IHasHead {
   ...
   public AbstractEpicTraderBipedModel(float modelSize) {
      this(RenderType::getEntityCutoutNoCull, modelSize, 0.0F, 256, 128);
   }

   protected AbstractEpicTraderBipedModel(float modelSize, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
      this(RenderType::getEntityCutoutNoCull, modelSize, yOffsetIn, textureWidthIn, textureHeightIn);
   }

   public AbstractEpicTraderBipedModel(Function<ResourceLocation, RenderType> renderTypeIn, float modelSizeIn, float yOffsetIn, int textureWidthIn, int textureHeightIn) {
   ...
   public void setModelAttributes(AbstractEpicTraderBipedModel<T> modelIn) {
