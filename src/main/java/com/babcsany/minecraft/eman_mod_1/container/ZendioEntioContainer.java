...
public class ZendioEntioContainer extends RecipeBookContainer<CraftingInventory> {
    ...
    private final ZendioEntioInventory craftingTableInventory = new ZendioEntioInventory();
    private final IWorldPosCallable field_217070_e;
    private final PlayerEntity player;

    public ZendioEntioContainer(int windowId, PlayerInventory playerInventory) {
        this(windowId, playerInventory, IWorldPosCallable.DUMMY);
    }

    public ZendioEntioContainer(int windowId, PlayerInventory playerInventory, IWorldPosCallable p_i50090_3_) {
        super(ContainerInit.ZENDIO_ENTIO_CONTAINER.get(), windowId);
    ...
    public ZendioEntioContainer(int windowId, PlayerInventory playerInventory, PacketBuffer packetBuffer) {
        this(windowId, playerInventory, IWorldPosCallable.DUMMY);
    }
