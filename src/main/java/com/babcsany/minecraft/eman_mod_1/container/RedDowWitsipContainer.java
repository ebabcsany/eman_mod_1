...
import com.babcsany.minecraft.eman_mod_1.inventory.RedDowWitsipInventory;
...
public class RedDowWitsipContainer extends RecipeBookContainer<CraftingInventory> {
    ...
    private final RedDowWitsipInventory craftingTableInventory = new RedDowWitsipInventory();
    private final IWorldPosCallable field_217070_e;
    private final PlayerEntity player;

    public RedDowWitsipContainer(int windowId, PlayerInventory playerInventory) {
        this(windowId, playerInventory, IWorldPosCallable.DUMMY);
    }

    public RedDowWitsipContainer(int windowId, PlayerInventory playerInventory, IWorldPosCallable p_i50090_3_) {
        super(ContainerInit.RED_DOW_WITSIP_CONTAINER.get(), windowId);
    ...
    public RedDowWitsipContainer(int windowId, PlayerInventory playerInventory, PacketBuffer packetBuffer) {
        this(windowId, playerInventory, IWorldPosCallable.DUMMY);
    }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(this.field_217070_e, playerIn, BlockInit.RED_DOW_WITSIP.get());
    }
