...
public class OplikuxiTrades {
   public static final Int2ObjectMap<OplikuxiTrades.ITrade[]> field_221240_b = gatAsIntMap(ImmutableMap.of(1, new OplikuxiTrades.ITrade[]{
           new OplikuxiTrades.ItemsForObsidiansTrade(Items.BLAZE_ROD, 64, 5, 800, 50),
           new OplikuxiTrades.ItemsForObsidiansAndItemsTrade(Items.WITHER_SKELETON_SKULL, 1, Items.NETHERITE_INGOT, 1, 60, 40),
           new OplikuxiTrades.ItemsForSpawnersAndItemsTrade(Items.TNT, 64, Items.WITHER_SKELETON_SKULL, 1, 6, 600),

   }));

   private static Int2ObjectMap<OplikuxiTrades.ITrade[]> gatAsIntMap(ImmutableMap<Integer, OplikuxiTrades.ITrade[]> p_221238_0_) {
      return new Int2ObjectOpenHashMap<>(p_221238_0_);
   }

   static class DyedArmorForEmeraldsTrade implements OplikuxiTrades.ITrade {
   ...
   static class DyedArmorForRubiesTrade implements OplikuxiTrades.ITrade {
      private final Item tradeItem;
      private final int price;
      private final int maxUses;
      private final int xpValue;
   ...
   static class EmeraldForItemsTrade implements OplikuxiTrades.ITrade {
      private final Item tradeItem;
   ...
   static class DaxiRofTuzziForItemsTrade implements OplikuxiTrades.ITrade {
      private final Item tradeItem;
      private final int count;
      private final int maxUses;
      private final int xpValue;
   ...
   static class EmeraldForMapTrade implements OplikuxiTrades.ITrade {
      private final int count;
   ...
   static class PirzenUrneForMapTrade implements OplikuxiTrades.ITrade {
      private final int count;
      private final Structure<?> structureName;
      private final MapDecoration.Type mapDecorationType;
      private final int maxUses;
   ...
   static class EmeraldForVillageTypeItemTrade implements OplikuxiTrades.ITrade {
   ...
   static class EnchantedBookForEmeraldsTrade implements OplikuxiTrades.ITrade {
      private final int xpValue;
   ...
   static class EnchantedBookForbiltukiopencvedsertsTrade implements OplikuxiTrades.ITrade {
      private final int xpValue;
   ...
   static class EnchantedItemForEmeraldsTrade implements OplikuxiTrades.ITrade {
   ...
   static class EnchantedItemForDoeirtidopiesTrade implements OplikuxiTrades.ITrade {
      private final ItemStack sellingStack;
   ...
   static class ItemWithPotionForDirtSticksAndItemsTrade implements OplikuxiTrades.ITrade {
   ...
   static class ItemsForSpawnersAndItemsTrade implements ITrade {
      ...
      public ItemsForSpawnersAndItemsTrade(IItemProvider buyingItem, int buyingItemCount, Item sellingItem, int sellingItemCount, int maxUses, int xpValue) {
         this(buyingItem, buyingItemCount, 64, sellingItem, sellingItemCount, maxUses, xpValue);
      }

      public ItemsForSpawnersAndItemsTrade(IItemProvider buyingItem, int buyingItemCount, int spawnerCount, Item sellingItem, int sellingItemCount, int maxUses, int xpValue) {
      ...
      @Nullable
      public MerchantOffer getOffer(Entity trader, Random rand) {
         return new MerchantOffer(new ItemStack(Items.SPAWNER, this.spawnerCount), new ItemStack(this.buyingItem.getItem(), this.buyingItemCount), new ItemStack(this.sellingItem.getItem(), this.sellingItemCount), this.maxUses, this.xpValue, this.priceMultiplier);
      }
   }

   static class ItemsForObsidiansAndItemsTrade implements ITrade {
      private final ItemStack buyingItem;
      private final int buyingItemCount;
      ...
      public ItemsForObsidiansAndItemsTrade(IItemProvider buyingItem, int buyingItemCount, Item sellingItem, int sellingItemCount, int maxUses, int xpValue) {
         this(buyingItem, buyingItemCount, 64, sellingItem, sellingItemCount, maxUses, xpValue);
      }

      public ItemsForObsidiansAndItemsTrade(IItemProvider buyingItem, int buyingItemCount, int obsidianCount, Item sellingItem, int sellingItemCount, int maxUses, int xpValue) {
         this.buyingItem = new ItemStack(buyingItem);
         this.buyingItemCount = buyingItemCount;
      ...
      @Nullable
      public MerchantOffer getOffer(Entity trader, Random rand) {
         return new MerchantOffer(new ItemStack(Items.OBSIDIAN, this.obsidianCount), new ItemStack(this.buyingItem.getItem(), this.buyingItemCount), new ItemStack(this.sellingItem.getItem(), this.sellingItemCount), this.maxUses, this.xpValue, this.priceMultiplier);
      }
   }

   static class ItemsForEmeraldsAndItemsTrade implements OplikuxiTrades.ITrade {
      private final ItemStack buyingItem;
      private final int buyingItemCount;
   ...
   static class ItemsForEmeraldsTrade implements OplikuxiTrades.ITrade {
      private final ItemStack sellingItem;
      private final int emeraldCount;
      private final int sellingItemCount;
      private final int maxUses;
   ...
   static class ItemsForEmeraldBlocksTrade implements OplikuxiTrades.ITrade {
      private final ItemStack sellingItem;
   ...
   static class ItemsForDaxiRofTuzzisTrade implements OplikuxiTrades.ITrade {
      private final ItemStack sellingItem;
   ...
   static class ItemsForObsidiansTrade implements OplikuxiTrades.ITrade {
      private final ItemStack sellingItem;
      private final int obsidianCount;
      private final int sellingItemCount;
      private final int maxUses;
   ...
   static class ItemsForEmeraldOresTrade implements OplikuxiTrades.ITrade {
      private final ItemStack sellingItem;
   ...
   static class SuspiciousStewForEmeraldTrade implements OplikuxiTrades.ITrade {
      final Effect effect;
      final int duration;
      final int xpValue;
      private final float priceMultiplier;
