...
import com.babcsany.minecraft.eman_mod_1.entity.ai.goal.ZombieTraderLookAtCustomerGoal;
import com.babcsany.minecraft.eman_mod_1.entity.ai.goal.ZombieTraderTradeWithPlayerGoal;
...
public class Oplikuxi extends AbstractEpicTrader {
   @Nullable
   private BlockPos zombieTraderTarget;
   private int despawnDelay;

   public Oplikuxi(EntityType<? extends Oplikuxi> type, World worldIn) {
      super(type, worldIn);
   ...
   protected void populateTradeData() {
      OplikuxiTrades.ITrade[] aZombietTraderTrades$itrade = OplikuxiTrades.field_221240_b.get(1);
      if (aZombietTraderTrades$itrade != null) {
         MerchantOffers merchantoffers = this.getOffers();
         int i = this.rand.nextInt(aZombietTraderTrades$itrade.length);
         this.addTrades1(merchantoffers, aZombietTraderTrades$itrade, 4);
         OplikuxiTrades.ITrade zombieTraderTrades$itrade = aZombietTraderTrades$itrade[i];
