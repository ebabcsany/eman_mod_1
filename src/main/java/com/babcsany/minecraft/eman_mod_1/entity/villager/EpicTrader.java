...
public class EpicTrader extends AbstractEpicTrader {
   @Nullable
   private BlockPos zombieTraderTarget;
   private int despawnDelay;

   public EpicTrader(EntityType<? extends EpicTrader> type, World worldIn) {
      super(type, worldIn);
   ...
   protected void populateTradeData() {
      EpicTraderTrades.ITrade[] aZombietTraderTrades$itrade = EpicTraderTrades.field_221240_b.get(1);
      if (aZombietTraderTrades$itrade != null) {
         ...
         EpicTraderTrades.ITrade zombieTraderTrades$itrade = aZombietTraderTrades$itrade[i];
