...
import com.babcsany.minecraft.eman_mod_1.init.SoundInit;
...
public class Zerunerdifirte extends AnimalEntity {

    private EatGrassGoal eatGrassGoal;
    private int eatingGrassTimer;
    private Object lightningBolt;

    public Zerunerdifirte(EntityType<Zerunerdifirte> entityType, World world) {
        super(entityType, world);
    }

    @Override
    public AgeableEntity createChild(AgeableEntity ageable) {
        Zerunerdifirte entity = new Zerunerdifirte(EntityInit.ZERUNERDIFIRTE.get(), this.world);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3,
                new TemptGoal(this, 11.5D, Ingredient.fromItems(ItemInit.SAJT.get()), false));
        this.goalSelector.addGoal(4, new FollowParentGoal(this, 1.1D));
        this.goalSelector.addGoal(5, this.eatGrassGoal);
        this.goalSelector.addGoal(2, new ZerunerdifirteAttackGoal(this, 1.0D, false));
