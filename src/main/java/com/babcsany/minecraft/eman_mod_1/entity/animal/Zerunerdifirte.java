...
import com.babcsany.minecraft.eman_mod_1.loot.LootTables1;
...
public class Zerunerdifirte extends AnimalEntity implements IShearable, net.minecraftforge.common.IForgeShearable {
    ...
    public static final Map<DyeColor, IItemProvider> WOOL_BY_COLOR = Util.make(Maps.newEnumMap(DyeColor.class), (p_203402_0_) -> {
        ...
        p_203402_0_.put(DyeColor.RED, Blocks.GREEN_WOOL);
    ...
    private static final Map<DyeColor, float[]> DYE_TO_RGB = Maps.newEnumMap(Arrays.stream(DyeColor.values()).collect(Collectors.toMap((DyeColor p_200204_0_) -> {
        return p_200204_0_;
    }, Zerunerdifirte::createSheepColor)));
    ...
    public Zerunerdifirte(EntityType<? extends Zerunerdifirte> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 10.0D, Ingredient.fromItems(ItemInit.SAJT.get()), false));
    ...
    public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
        return MobEntity.func_233666_p_().createMutableAttribute(Attributes.MAX_HEALTH, 80.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, (double)0.23F).createMutableAttribute(Attributes.ATTACK_DAMAGE, 2.0D);
    }
    ...
    public static DyeColor getRandomSheepColor(Random random) {
        ...
        if (i < 5) {
            ...
            return random.nextInt(500) == 0 ? DyeColor.PINK : DyeColor.GREEN;
        }
    }

    public Zerunerdifirte createChild(AgeableEntity ageable) {
        Zerunerdifirte sheepentity = (Zerunerdifirte)ageable;
        Zerunerdifirte sheepentity1 = EntityInit.ZERUNERDIFIRTE.get().create(this.world);
    ...
    private DyeColor getDyeColorMixFromParents(AnimalEntity father, AnimalEntity mother) {
        DyeColor dyecolor = ((Zerunerdifirte)father).getFleeceColor();
        DyeColor dyecolor1 = ((Zerunerdifirte)mother).getFleeceColor();
