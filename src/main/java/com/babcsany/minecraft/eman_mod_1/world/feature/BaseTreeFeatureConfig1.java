...
public class BaseTreeFeatureConfig1 implements IFeatureConfig {
   public static final Codec<BaseTreeFeatureConfig1> CODEC_BASE_TREE_FEATURE_CONFIG = RecordCodecBuilder.create((p_236683_0_) -> {
      ...
      })).apply(p_236683_0_, BaseTreeFeatureConfig1::new);
   });
   ...
   protected BaseTreeFeatureConfig1(BlockStateProvider p_i232020_1_, BlockStateProvider p_i232020_2_, FoliagePlacer p_i232020_3_, AbstractTrunkPlacer p_i232020_4_, AbstractFeatureSizeType p_i232020_5_, List<TreeDecorator> p_i232020_6_, int p_i232020_7_, boolean p_i232020_8_, Heightmap.Type p_i232020_9_) {
   ...
   public BaseTreeFeatureConfig1 func_236685_a_(List<TreeDecorator> p_236685_1_) {
      return new BaseTreeFeatureConfig1(this.trunkProvider, this.leavesProvider, this.field_236677_f_, this.field_236678_g_, this.field_236679_h_, p_236685_1_, this.field_236680_i_, this.field_236681_j_, this.field_236682_l_);
   }
   ...
   public static class Builder {
      ...
      public BaseTreeFeatureConfig1.Builder func_236703_a_(List<TreeDecorator> p_236703_1_) {
         this.decorators = p_236703_1_;
         return this;
      }

      public BaseTreeFeatureConfig1.Builder func_236701_a_(int p_236701_1_) {
         this.field_236697_g_ = p_236701_1_;
         return this;
      }

      public BaseTreeFeatureConfig1.Builder setIgnoreVines() {
         this.field_236698_h_ = true;
         return this;
      }

      public BaseTreeFeatureConfig1.Builder func_236702_a_(Heightmap.Type p_236702_1_) {
         this.field_236699_i_ = p_236702_1_;
         return this;
      }

      public BaseTreeFeatureConfig1 build() {
         return new BaseTreeFeatureConfig1(this.trunkProvider, this.leavesProvider, this.field_236694_c_, this.field_236695_d_, this.field_236696_e_, this.decorators, this.field_236697_g_, this.field_236698_h_, this.field_236699_i_);
      }
   }
}