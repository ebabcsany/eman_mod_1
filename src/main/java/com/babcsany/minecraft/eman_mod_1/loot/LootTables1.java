package com.babcsany.minecraft.eman_mod_1.loot;
...
public class LootTables1 {
   ...
   public static final ResourceLocation ENTITIES_ZERUNERDIFIRTE = register("entities/kiwiterdia");
