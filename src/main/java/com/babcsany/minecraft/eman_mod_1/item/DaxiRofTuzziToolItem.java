...
public class DaxiRofTuzziToolItem extends TieredDaxiRofTuzziItem implements IVanishable {
   ...
   public DaxiRofTuzziToolItem(float attackDamageIn, float attackSpeedIn, IItemTier1 tier, Set<Block> effectiveBlocksIn, Properties builderIn) {
