...
import com.babcsany.minecraft.eman_mod_1.entity.projectile.IrtatedserwintKrezonEntity;
...
public class IrtatedserwintKrezonItem extends Item {
   public IrtatedserwintKrezonItem(Properties builder) {
      super(builder);
   }
