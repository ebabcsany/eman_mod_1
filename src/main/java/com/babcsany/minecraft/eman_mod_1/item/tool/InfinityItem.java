...
public class InfinityItem extends TieredItem implements IVanishable {
   private float attackDamage;
   /** Modifiers applied when the item is in the mainhand of a user. */
   private Multimap<Attribute, AttributeModifier> attributeModifiers;

   public InfinityItem(IItemTier tier, int attackDamageIn, float attackSpeedIn, Item.Properties builderIn) {
   ...
   public static HoeItem hoeItem;
   public static PickaxeItem pickaxeItem;
   public static ShovelItem shovelItem;
   public static SwordItem swordItem;
   ...
   public InfinityItem(IItemTier tier, float attackDamageIn, float attackSpeedIn, Properties builder) {
      super(tier, builder);
   }
   ...
   public float getDestroySpeed(ItemStack stack, BlockState state) {
      ...
      if (state.isIn(Blocks.COBWEB)) {
         return 15.0F;
      } else if (!state.isIn(Blocks.COBWEB)) {
